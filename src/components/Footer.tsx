    ...
    <footer className="bg-dark-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-semibold mb-4">AnsAds</h3>
            <p className="text-gray-300 mb-6 max-w-xs">
              Creating impactful digital advertising solutions that drive results and help businesses thrive in the digital landscape.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPin size={20} className="mr-3 text-primary-400 mt-1 flex-shrink-0" />
                <span className="text-gray-300">123 Advertising Avenue, Marketing City, MC 10101</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@ansads.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {currentYear} AnsAds. All Rights Reserved.
            </p>
